...
import {
  ...
  FaGithub, FaDocker, FaCode, FaSearch, FaDatabase, FaNetworkWired
} from 'react-icons/fa';
import {
...
function Skills() {
  ...
  const iconMap = {
    ...
    Autopsy: <FaSearch color="#F5792A" size={40} />,
    MariaDB: <FaDatabase color="#4479A1" size={40} />,
    NMAP: <FaNetworkWired color="#F5792A" size={40} />,
  };
